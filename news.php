            ...
            <div class="modal-body text-center">
                ...
                <div class=" mt-4 mb-4">
                    ...
                    <div class="embed-responsive embed-responsive-16by9">
                        <iframe width="450" height="215" src="https://www.youtube.com/embed/DjuCBJNqpWA" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                    <p>
    ...
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body text-center-justify">
                ...
                <div class=" mt-4 mb-4">
                    <p>
                        Um lindo dia de sol marcou a ação integrada realizada pela Fundação Municipal de Ação Social (FUMAS) e Unidades de Gestão de Educação (UGE) e Infraestrutura e Serviços Públicos (UGISP) no Jardim São Camilo, na manhã desta quinta (21): a grafitagem do novo viaduto da Rua João Pinheiro dos Santos e o plantio de árvores no platô ao lado da Viela Sebastião Carneiro Coutinho (Viela do Pelé).
                    </p>
                    <p>
                        Cinco grafiteiros integrantes do Coletivo The King´s – que há duas semanas realizou uma oficina de hip-hop para as crianças assistidas pelo Programa de Suplementação Alimentar (PSA) e também para os alunos da Associação Almater – foram os responsáveis pelos desenhos no viaduto. “Na oficina, pedimos que elas desenhassem o que gostariam de ver aqui no bairro onde moram, então, fizemos uma junção dos desenhos e percebemos que haviam muitos assuntos similares, como flores, parques, brinquedos e muita cor”, destacou Jociel Dune, integrante do Coletivo.
                    </p>
                    <p>
