    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-12 text-center mt-3">
                ...
                <h1 class="display-3">Mitos e Verdades</h1>
                <p></p>
        ...
        <div class="row">
            ...
            <div class="col-3">
                ...
                <nav id="navbarVertical" class="navbar navbar-light bg-light">
                    ...
                    <nav class="nav nav-pills flex-column">
                        ...
                        <a class="nav-link" href="#item1">Grafite x pichação: qual a diferença?</a>
                        <nav class="nav nav-pills flex-column">

                            <a class="nav-link ml-3 my-2" href="#item1-1">Pichação e grafite não são a mesma coisa. </a>
                            <a class="nav-link ml-3 my-2" href="#item1-2">Pichação é crime. Grafite não é.</a>

                        </nav>
                        <a class="nav-link" href="#item2">Como tratar propriedades particular e pública?</a>
                        <a class="nav-link" href="#item3">Se o grafite é bom para a cidade e tanta gente quer exercitar sua arte por aí, precisamos mesmo de mais um programa público?</a>
            ...
            <div class="col-9">
                ...
                <div data-spy="scroll" data-target="#navbarVertical" data-offset="0" class="scrollspySite ">
                    ...
                    <h3 id="item1">Grafite x pichação: qual a diferença?</h3>

                    <p>Existe uma linha tênue que separa o grafite da pichação, e a pichação do vandalismo. Reconhecer a diferença entre essas formas de comunicação urbana – tão intimamente relacionadas ao longo da história – pode ser a chave que faltava para envolver as pessoas em uma série de atividades relacionadas ao tema: oficinas, debates, excursões, testes de conhecimento.</p>

                    <h4 id="item1-1"> Pichação e grafite não são a mesma coisa. </h4>
                    ...
                    <h4 id="item1-2">Pichação é crime. Grafite não é.</h4>
                    ...
                    <h3 id="item2">Como tratar propriedades particular e pública?</h3>
                    ...
                    <h3 id="item3"> Se o grafite é bom para a cidade e tanta gente quer exercitar sua arte por aí, precisamos mesmo de mais um programa público?</h3>
                    ...
                    <p>
                        <u> O debate sobre grafites revelou um fato óbvio sobre a cidade: temos muros, concreto e empenas demais.</u>
                    </p>
                    <p>
                    ...
                    <div class=" row justify-content-center align-items-center mt-5 mb-4">
                        ...
                        <p>
                            Há espaço de sobra para plantar mais árvores, para grafites criativos, e também há os muros que poderiam simplesmente não existir.
                        </p>
                        <p>
                            * Fragmentos do artigo publicado originalmente no blog Caminhadas Urbanas do Estadão.
                        </p>
                    </div>
