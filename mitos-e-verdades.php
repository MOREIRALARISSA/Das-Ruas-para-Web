...
<main class="mt-4 mb-4">
    ...
    <p>
        <b> Pichação e grafite não são a mesma coisa. </b>
    </p>
    <p>
    ...
    <p>Uma casa pichada é uma agressão visual e ainda gera um ônus para o dono, que acorda um dia e vê um rabisco hediondo na sua parede. Até os grafites acabam pichados. Um prédio pichado dá uma impressão de abandono, de cidade tomada, de terra de ninguém. E a cidade não é de ninguém, é, ao contrário de todos. O sujeito que picha impõe sua vontade estética (!) à de todos os outros. Portanto, estamos tratando de assuntos que são diferentes, e merecem tratamento diferente. </p>
    ...
    <p>
        <b>Pichação é crime. Grafite não é.</b>
    </p>
    <p>
    ...
    <p>
        <b> Como tratar propriedades particular e pública?</b>
    </p>
    ...
    <p>
        <b> Se o grafite é bom para a cidade e tanta gente quer exercitar sua arte por aí, precisamos mesmo de mais um programa público?</b>
    </p>
    <p>
