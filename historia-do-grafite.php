        ...
        <div class="row justify-content-center">
            ...
            <div class="card mb-3 col-lg-5 mx-auto">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">• Grafiteiro/writter: o artista que pinta;</p>
                    <p class="card-text">• Bite: imitar o estilo de outro grafiteiro;</p>
                    <p class="card-text">• Tag: é a assinatura de grafiteiro;</p>
                    <p class="card-text">• Toy: é o grafiteiro iniciante.</p>
