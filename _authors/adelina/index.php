...
// include ('./../../header-estilos.php'); //Incluindo o menu de navegação ?>
                                ...
                                <article>
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-lg-4 offset-lg-0 order-lg-first col-md-5 offset-md-1 col-sm-6 offset-sm-0 pl-0 pr-0">
                                            <figure>
                                                <img class="img-fluid" src="../../_images/adelina/KurtWenner.jpg" alt="" />
                                            </figure>
                                        ...
                                        <div class="col-lg-4 offset-lg-0 order-lg-first col-md-5 offset-md-1 col-sm-6 offset-sm-0 pl-0 pr-0">
                                            <figure>
                                                <img class="img-fluid" src="../../_images/adelina/KurtWenner6.jpg" alt="" />
                                            </figure>
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="avatar mx-auto">
                                                    <img src="../../_images/adelina/EricGroheperfil.jpg" alt="Banksy">
                                                </div>
                                                <div class="card-body">
                                                    <!--                        <h4 class="card-title font-weight-bold">Caio César Assumpção Rosseto</h4>-->
                                                    <h2 class="card-title" font-weight-bold>Eric Groheper</h2>
...
-->
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-fundo"></div>
                                                <div class="avatar mx-auto">
                                                    <img src="../../_images/adelina/KurtWennerperfil.jpg" alt="Banksy">
                                                </div>
                                                <div class="card-body">
                                                    <!--                        <h4 class="card-title font-weight-bold">Caio César Assumpção Rosseto</h4>-->
                    ...
                    <!--ou Robin Gunningham[2]-->
                                                    ...
                                                    <p class="card-text">é um grande gênio da modernidade. Ele nasceu em Ann Arbor - Michigan, hoje, mundialmente conhecido pelas suas pinturas de rua.</p>
                                                </div>

                                                <ul class="list-group list-group-flush">
                                                    <li class="list-group-item">Ann Arbor - Michigan</li>
                                                    <!--                        <li class="list-group-item">Período: Arte urbana</li>-->
                                                    <li class="list-group-item">artista gráfico, e ilustrador de projetos espaciais e paisagens extra-terrestres</li>
                                                    <!--
<li class="list-group-item">Série: Better Out Than In</li>
<li class="list-group-item">Filmes: Saída Pela Loja, The Antics Roadshow, Rebel Rocket Attack</li>
-->
                                    ...
                                    <div class="row justify-content-lg-center mb-5">
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-fundo"></div>
                                                <div class="avatar mx-auto">
                                                    <img src="../../_images/adelina/TracyLeeStumperfil.jpg" alt="Banksy">
                                                </div>
                                                <div class="card-body">
                                                    <!--                        <h4 class="card-title font-weight-bold">Caio César Assumpção Rosseto</h4>-->
                    ...
                    <!--ou Robin Gunningham[2]-->
                                                    ...
                                                    <p class="card-text">É uma artista com um talento respeitado internacionalmente .</p>
                                                </div>

                                                <ul class="list-group list-group-flush">
                                                    <li class="list-group-item"> nasceu em Chambersburg, Pensilvânia, e foi criada em West Chester, um subúrbio da Filadélfia</li>
                                                    <!--                        <li class="list-group-item">Período: Arte urbana</li>-->
                                                    <li class="list-group-item">É uma pintora conhecida internacionalmente</li>
                                                    <!--
<li class="list-group-item">Série: Better Out Than In</li>
<li class="list-group-item">Filmes: Saída Pela Loja, The Antics Roadshow, Rebel Rocket Attack</li>
-->
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-fundo"></div>
                                                <div class="avatar mx-auto">
                                                    <img src="../../_images/adelina/JulianBeeverperfil.jpg" alt="Banksy">
                                                </div>
                                                <div class="card-body">
                                                    <!--                        <h4 class="card-title font-weight-bold">Caio César Assumpção Rosseto</h4>-->
                    ...
                    <!--ou Robin Gunningham[2]-->
                                                    ...
                                                    <p class="card-text">É um artista inglês nascido em Cheltenham,</p>
                                                </div>

                                                <ul class="list-group list-group-flush">
                                                    <li class="list-group-item">nascido em Cheltenham, Reino Unido 1959. Cresceu em Melton Mowbray. </li>
                                                    <!--                        <li class="list-group-item">Período: Arte urbana</li>-->
                                                    <li class="list-group-item">Julian cria desenhos tridimensionais utilizando giz como material e trabalha para várias empresas como freelancer, </li>
                                                    <!--
<li class="list-group-item">Série: Better Out Than In</li>
<li class="list-group-item">Filmes: Saída Pela Loja, The Antics Roadshow, Rebel Rocket Attack</li>
-->
                                ...
                                <section class="12">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4  offset-lg-0 col-md-6 offset-md-0 order-md-first order-sm-first ">
                                            <img class=" img-fluid galeria " src="../../_images/adelina/KurtWenner5.jpg" alt="img">
                                            <figcaption>
                                        ...
                                        <div class="col-lg-4  offset-lg-0 col-md-6 offset-md-0 order-md-first order-sm-first ">
                                            <img class=" img-fluid galeria " src="../../_images/adelina/EricGrohe4.jpg" alt="img">
                                            <figcaption>
                                        ...
                                        <div class="col-lg-4  offset-lg-0 col-md-6 offset-md-0 order-md-first order-sm-first ">
                                            <img class=" img-fluid galeria " src="../../_images/adelina/TracyLeeStum8.jpg" alt="img">
                                            <figcaption>
                                        ...
                                        <div class="col-lg-4  offset-lg-0 col-md-6 offset-md-0 order-md-first order-sm-first ">
                                            <img class=" img-fluid galeria " src="../../_images/adelina/TracyLeeStum7.jpg" alt="img">
                                            <figcaption>
                                                Pintura de Tracy Lee Stum.
                                            </figcaption>
                                        </div>
                                        ...
                                        <div class="col-lg-4  offset-lg-0 col-md-6 offset-md-0 order-md-first order-sm-first ">
                                            <img class=" img-fluid galeria " src="../../_images/adelina/JulianBeever6.jpg" alt="img">
                                            <figcaption>
                                        ...
                                        <div class="col-lg-4  offset-lg-0 col-md-6 offset-md-0 order-md-first order-sm-first ">
                                            <img class=" img-fluid galeria " src="../../_images/adelina/TracyLeeStum5.jpg" alt="img">
                                            <figcaption>
                                                Pintura de Julian Beever.
                                            </figcaption>
                                        </div>
