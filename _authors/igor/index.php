                    ...
                    <div class="tab-content" id="nav-pills-content">
                        <div class="tab-pane fade show active" id="nav-item-01" role="tabpanel">
                            ...
                            <div class="row justify-content-center">
                                ...
                                <div class="col-lg-4">
                                    <p>O estilo FREESTYLE inclui toda criação do grafite já feita, misturando letras, desenhos e tags (assinaturas), Spray, látex, canetão, colagem de stickers,
                                        são algumas formas e materiais usados nessa categoria da arte, é um grafite sem esboço. É conhecido tambem como um estilo livre,onde os artistas grafitam no improviso.</p>
                                    <p>O nome FreeStyle é uma de várias gírias usadas pelos grafiterios como:
                                        <p>Bite significa imitar o estilo de outro grafiteiro;</p>
                                        <p>Crew é o nome dado ao conjunto de grafiteiros que praticam a sua arte em conjunto e simultaneamente;</p>
                                        <p>Tag é a assinatura do grafiteiro;</p>
                                        <p>Piece é um grafite onde se usa mais de 3 cores;</p>
                                        <p>Toy é o nome dado a um grafiteiro iniciante;</p>
                                        <p>Spot é o lugar onde o grafite é feito;</p>
                                        <p>Wildstyle é um estilo específico de grafite caracterizado pelo uso de letras entrelaçadas;</p>
                                        <p>Bomb é o nome dado ao grafite ilegal, feito por isso de modo rápido e durante a noite. Quem faz o bomb é chamado de bomber.</p>
                                </div>
                        ...
                        <div class="tab-pane fade show " id="nav-item-02" role="tabpanel">
                            ...
                            <div class="row justify-content-lg-center">
                                <div class="col-lg-4 col-md-4">
                                    <div>
                                        <figure>
                                            <img src="./../../_images/igor/artistamany.jpg" alt="" />
                                            <figcaption>
                                                Many
                                            </figcaption>
                                        </figure>
                                ...
                                <div class="col-lg-4 offset-lg-1 col-md-4">
                                    <div>
                                        <figure>
                                            <img src="./../../_images/igor/artistamono.jpg" alt="" />
                                            <figcaption>
                                                Mono
                                            </figcaption>
                                        </figure>
                            ...
                            <div class="row justify-content-lg-center">
                                <div class="col-lg-4 col-md-4">
                                    <div>
                                        <figure>
                                            <img src="./../../_images/igor/artistatalu.jpg" alt="" />
                                            <figcaption>
                                                Talu
                                            </figcaption>
                                        </figure>
                                ...
                                <div class="col-lg-4 offset-lg-1 col-md-4">
                                    <div>
                                        <figure>
                                            <img src="./../../_images/igor/wildstylebrasil.jpg" alt="" />
                                            <figcaption>
                                                Wildstylebrasil
                                            </figcaption>
                                        </figure>
                        ...
                        <div class="tab-pane fade show " id="nav-item-03" role="tabpanel">
                            ...
                            <div class="row justify-content-lg-center">
                                <div class="col-lg-4 col-md-4">
                                    <img src="./../../_images/igor/manyfaceses1.jpg" alt="" />
                                </div>
                                <div class="col-lg-4 col-md-4">
                                    <img src="./../../_images/igor/manyfaceses2.jpg" alt="" />
                                </div>
                                <div class="col-lg-4 col-md-4">
                                    <img src="./../../_images/igor/wildstyle.jpg" alt="" />
                                </div>
                                <div class="col-lg-4 col-md-4">
                                    <img src="./../../_images/igor/wildstyle2.jpg" alt="" />
                                </div>
                                <div class="col-lg-4 col-md-4">
                                    <img src="./../../_images/igor/wildstylebrasil1.jpg" alt="" />
                                </div>
                                <div class="col-lg-4 col-md-4">
                                    <img src="./../../_images/igor/mono.jpg" alt="" />
                                </div>
